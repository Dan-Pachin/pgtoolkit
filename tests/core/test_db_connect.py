...
from core.connect_to_database import connect_to_database  # Replace with actual path
...
def test_successful_connection_first_try(mocker):
    ...
    mock_connect.assert_called_once_with(dbname="mydb", user="myuser")
...
def test_connection_requires_password_then_succeeds(mocker):
    ...
    mock_connect.assert_called_with(dbname="mydb", user="myuser", password="secret")
